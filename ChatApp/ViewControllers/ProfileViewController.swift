...
//  ChatApp
//
//  Created by Adrian Inculet on 08.10.2025.
//
...
class ProfileViewController: UIViewController {
    ...
    @IBAction func logoutButtonTapped(_ sender: Any) {
        let logoutAlert = UIAlertController(title: "Confirm Logout", message: "Are you sure you want to logout of your account?", preferredStyle: .alert)
